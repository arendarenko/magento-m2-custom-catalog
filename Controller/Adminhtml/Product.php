...
abstract class Product extends Action
{
     ...
     * @return Redirect
     */
    public function processRedirect(CustomProductInterface $customProduct = null): Redirect
    {
        ...
        if ($customProduct && $this->getRequest()->getParam('back')) {
            if ($customProduct->getId()) {
                return $resultRedirect->setPath('*/*/edit', ['entity_id' => (int)$customProduct->getId()]);
            } else {
